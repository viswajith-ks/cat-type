...
public class wpmgame {
    ...
    public void highscores() {
        ...
        if (choice == 'h') {
            ...
            if(i==wll.size()-1)
                System.out.println("\033[33m" + (float) wll.get(i).wpm + " wpm    " + (float) wll.get(i).cps + " cps    " + (float) wll.get(i).accuracy + " %    " + (float) wll.get(i).time + " s" + "\033[0m 🥇\n");
            else if(i==wll.size()-2)
                System.out.println("\033[36m" + (float) wll.get(i).wpm + " wpm    " + (float) wll.get(i).cps + " cps    " + (float) wll.get(i).accuracy + " %    " + (float) wll.get(i).time + " s" + "\033[0m 🥈\n");
            else if(i==wll.size()-3)
                System.out.println("\033[35m" + (float) wll.get(i).wpm + " wpm    " + (float) wll.get(i).cps + " cps    " + (float) wll.get(i).accuracy + " %    " + (float) wll.get(i).time + " s" + "\033[0m 🥉\n");
            else
                System.out.println((float) wll.get(i).wpm + " wpm    " + (float) wll.get(i).cps + " cps    " + (float) wll.get(i).accuracy + " %" + (float) wll.get(i).time);
            }
            choice = sc.next().charAt(0);
        }
    }
